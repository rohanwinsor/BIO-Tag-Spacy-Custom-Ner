...
def train(data_path, labels,  model=None, new_model_name='new_model', output_dir=None, n_iter=10):
...
if __name__ == '__main__':
    ...
    LABEL = ['Tag', 'I-geo', 'B-geo', 'I-art', 'B-art', 'B-tim', 'B-nat', 'B-eve', 'O', 'I-per', 'I-tim', 'I-nat', 'I-eve', 'B-per', 'I-org', 'B-gpe', 'B-org', 'I-gpe']
    train("new_ner_corpus_260", LABEL, "en", new_model_name='new_model', output_dir="output", n_iter=10)
